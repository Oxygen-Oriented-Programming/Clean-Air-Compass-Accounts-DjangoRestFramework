...
class Account(AbstractBaseUser,PermissionsMixin):
   ...
   default_location = models.CharField(_('User Name'),max_length=150)
   default_distance = models.CharField(_('User Name'),max_length=150)
   alerts = models.CharField(_('User Name'),max_length=150)
